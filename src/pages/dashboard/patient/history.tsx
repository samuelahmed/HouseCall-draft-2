  ...
  return (
    <>
      ...
      <div>
        {session && (
          <>
            <div className="grid min-h-screen grid-cols-1 md:grid-cols-3 font-roboto ">
              ...
              <div className="col-span-1 bg-blue3">Completed</div>

              <div className="col-span-1 bg-olive10">Canceled</div>
