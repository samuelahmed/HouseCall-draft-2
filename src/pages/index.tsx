      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-blue1 dark:bg-darkBlue1 text-olive12 dark:text-darkBlue12">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8">
            <Link
              className="border border-blue6 dark:border-darkBlue6 bg-blue2 hover:bg-blue4 dark:bg-darkBlue2 dark:hover:bg-darkBlue4 flex max-w-xs flex-col gap-4 p-4"
