...
export const sessionRouter = router({
  ...
  createOneSession: privateProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      const { id, acceptedCaregiverId, name, address, medicalNotes, overview, title, hourlyRate, totalHours, totalCompensation } = input;
  ...
  getOneSessionTwo: privateProcedure
    ...
    //   getAllSessionsByPotentialCaregiver: privateProcedure.query(({ ctx }) => {
    //     if (!ctx.session || !ctx.session.user) {
    //       return null;
    //     }
